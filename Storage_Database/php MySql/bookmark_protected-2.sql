...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 04, 2022 lúc 06:32 AM
...
--
-- Cơ sở dữ liệu: `manager_pwd`
--

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `bookmark_protected`
--
...
--
-- Đang đổ dữ liệu cho bảng `bookmark_protected`
--
...
--
-- Chỉ mục cho bảng `bookmark_protected`
--
...
--
-- AUTO_INCREMENT cho bảng `bookmark_protected`
--
ALTER TABLE `bookmark_protected`
